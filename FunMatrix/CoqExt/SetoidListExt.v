...
Generalizable Variables A Aeq Aadd Azero Aopp Amul Aone Ainv.
...
Section Props_listA.
  ...
  Proof.
    intros l1. induction l1; destruct l2; intros; try (left; easy); try (right; easy).
    destruct (dec _ a a0),(IHl1 l2); auto.
...
Section nth.
  ...
  Proof.
    simp_proper.
    intros i j H. inv H. rename j into i. intros l1 l2. revert l2 i.
  ...
  Lemma list_eq_iff_nth : forall n (l1 l2 : list A)
  ...
  Proof.
    ...
    - generalize dependent l2. generalize dependent n.
      ...
      + destruct l2; simpl in *; try easy. f_equiv.
        ...
        * apply (IHl1 (length l2)); auto; try lia.
          intros. apply (H (S i)). lia.
  Qed.

  (** Get from `repeat x` always return x *)
...
Section fold_left.
  ...
  Context `{HAMonoid:AMonoid A Aadd Azero Aeq}.
